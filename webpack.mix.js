...
mix.js('resources/js/app.js', 'public_html/js/init.js')
    .sass('resources/sass/app.scss', 'public_html/css/init.css')
    .combine([
  ...
  .combine([
	...
	], 'public_html/css/vendor.css')
    .combine([
        'resources/plugins/AdminLTE/css/AdminLTE.rtl.min.css',
        'resources/plugins/bootstrap/css/bootstrap.rtl.min.css'
    ], 'public_html/css/rtl.css')
    .copy('resources/plugins/bootstrap/fonts/glyphicons-halflings-regular.woff2', 'public_html/fonts/')
    .copy('resources/plugins/bootstrap/fonts/glyphicons-halflings-regular.woff', 'public_html/fonts/')
    .copy('resources/plugins/bootstrap/fonts/glyphicons-halflings-regular.ttf', 'public_html/fonts/')
    .copy('resources/plugins/ionicons/fonts/ionicons.ttf', 'public_html/fonts/ionicons.ttf')
    .copyDirectory('node_modules/tinymce/skins/', 'public_html/js/skins/')
    .setResourceRoot('../');
