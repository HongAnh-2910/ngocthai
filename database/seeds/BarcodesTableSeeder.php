...
class BarcodesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        Barcode::create([
            'id'=>1,
            'name'=>'20 mã vạch trên mỗi tờ - (8.5" x 11")',
        ...
        Barcode::create([
            'id'=>2,
            'name'=>'30 mã vạch trên mỗi tờ - (8.5" x 11")',
        ...
        Barcode::create([
            'id'=>3,
            'name'=>'32 mã vạch trên mỗi tờ - (8.5" x 11")',
            'description'=>'Sheet Size: 8.5" x 11"\r\nLabel Size: 2" x 1.25"\r\nLabels per sheet: 32',
            'width'=>2,
            'height'=>1.25,
            'paper_width'=>8.5,
        ...
        Barcode::create([
            'id'=>4,
            'name'=>'40 mã vạch trên mỗi tờ - (8.5" x 11")',
            'description'=>'Sheet Size: 8.5" x 11"\r\nLabel Size: 2" x 1"\r\nLabels per sheet: 40',
            'width'=>2,
            'height'=>1,
            'paper_width'=>8.5,
        ...
        Barcode::create([
            'id'=>5,
            'name'=>'50 mã vạch trên mỗi tờ - (8.5" x 11")',
            'description'=>'Sheet Size: 8.5" x 11"\r\nLabel Size: 1.5" x 1"\r\nLabels per sheet: 50',
            'width'=>1.5,
            'height'=>1,
            'paper_width'=>8.5,
        ...
        Barcode::create([
            'id'=>6,
            'name'=>'Giấy cuộn - 31.75mm x 25.4mm',
