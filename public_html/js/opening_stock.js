...
function update_weight(tr) {
    // console.log(tr);
    var quantity = __read_number(tr.find('.purchase_quantity'));
    var weight = $('.weight_product').val() * quantity;
    var format_weight =  Math.round(weight * 10) / 10;
    tr.find('.row_weight').text(format_weight);
}
