      ...
      <div class="row">
          ...
          <div class="col-xs-6">
            ...
            <span class="display_currency" data-currency_symbol="true">
              {{$single_payment_line->type == 'expense' ? ($single_payment_line->amount * -1) : $single_payment_line->amount}}
            </span><br>
            ...
            @if(!empty($single_payment_line->bank_account_number))
              ...
              {{ $single_payment_line->bank_account_number }}<br/>
            @endif
          ...
          <div class="col-xs-6">
            ...
            {{ $approval_statuses[$single_payment_line->approval_status] }}
            <br>
