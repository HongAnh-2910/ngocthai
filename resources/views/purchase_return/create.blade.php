...
{{--	            </div>--}}
					...
					id="purchase_return_product_table">
						<thead>
							<tr>
								...
								<th class="text-center">
									@lang('purchase.purchase_total_quantity')
								</th>
								<th class="text-center">
	...
	<div class="row">
		<div class="col-md-12">
			<button type="button" id="submit_purchase_return_form" class="btn btn-primary pull-right btn-flat">@lang('messages.add')</button>
		</div>
	</div>
	{!! Form::close() !!}
</section>
