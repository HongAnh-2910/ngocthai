...
<td>
	<span class="row_weight">{{ $weight ? $weight : '' }}</span>
	<input type="hidden" class="weight_product" name="weight_product" value="{{ $product->weight }}">
</td>
...
{{--@endif--}}
	...
	@endforeach
								...
								<tfoot>
								<tr>
									<td colspan="@if($enable_expiry == 1 && $product->enable_stock == 1 && $enable_lot == 1) 6 @elseif(($enable_expiry == 1 && $product->enable_stock == 1) || $enable_lot == 1) @else 4 @endif"></td>
