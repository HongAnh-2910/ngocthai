  ...
  @php
    ...
    if(isset($update_action)) {
      ...
      if (request()->segments()[0] == 'contacts') {
          $supplier = isset($contact) && $contact->type == 'supplier';
      }
  @endphp
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title">{{ $supplier ? __('contact.update_supplier') : __('contact.update_customer') }}</h4>
    </div>
        ...
        <div class="clearfix"></div>
          ...
          <div class="col-md-4 customer_fields" style="{{ $supplier ? 'display: none' : 'display: block' }}">
              <div class="form-group">
                  ...
                  {!! Form::select('selling_price_group_id', $selling_price_groups, $contact->selling_price_group_id, ['class' => 'form-control', 'required']); !!}
              </div>
          </div>
        <div class="col-md-4">
          <div class="form-group">
        ...
        <div class="col-md-4 customer_fields">
          <div class="form-group">
              ...
              <div class="input-group">
                  ...
                  {!! Form::text('credit_limit', !empty($contact->credit_limit) ? @num_format($contact->credit_limit) : null , ['class' => 'form-control input_number']); !!}
              </div>
