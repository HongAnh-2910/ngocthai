        ...
        <div class="col-sm-12">
            @component('components.widget', ['class' => 'box-primary', 'title' => __('lang_v1.instructions')])
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        <td>7</td>
                        <td>@lang('contact.pay_term') <br>
{{--                            <small class="text-muted">(@lang('lang_v1.required_if_supplier'))</small>--}}
                    ...
                    <tr>
                        <td>8</td>
                        <td>@lang('contact.pay_term_period') <br>
{{--                            <small class="text-muted">(@lang('lang_v1.required_if_supplier'))</small>--}}
                            <small class="text-muted">(@lang('lang_v1.optional'))</small>
                        </td>
                    ...
                    <tr>
                        <td>18</td>
                        <td>@lang('lang_v1.selling_price_group') <small class="text-muted">(@lang('lang_v1.optional'))</small></td>
                        <td>@lang('contact.price_group_import_description')</td>
                    </tr>
                    <tr>
                        <td>19</td>
                        <td>@lang('lang_v1.customer_groups') <small class="text-muted">(@lang('lang_v1.optional'))</small></td>
                        <td>@lang('contact.customer_group_import_description')</td>
                    </tr>
                </table>
            @endcomponent
        </div>
