		...
		<div class="col-md-12">
			<table class="table text-center table-bordered" id="product_table">
				<thead id="product_table_head">
					<tr class="bg-gray">
						<th class="col-md-4">@lang('sale.product')</th>
						<th class="col-md-2">@lang('lang_v1.m_to_kg')</th>
						<th class="col-md-2">@lang('product.thinkness')</th>
                		...
                		<th class="col-md-2">@lang('business.business_locations')</th>
					</tr>
				</thead>
