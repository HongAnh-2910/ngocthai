...
{{--		<span class="input-group-addon"><small>@lang('product.exc_of_tax')</small></span>--}}
		{!! Form::text('products[' . $product->id . '][variations][' . $variation->id . '][default_sell_price]', @num_format($variation->default_sell_price), ['placeholder' => __('product.exc_of_tax'), 'class' => 'form-control input-sm input_number sp_exc_tax required']); !!}
	</div>
...
<td style="text-align: left;">
	@foreach($price_groups as $k => $v)
		...
		<div class="input-group" style="width: 100%;">
			...
			{!! Form::text('products[' . $product->id . '][variations][' . $variation->id . '][group_prices][m][' . $k . ']', !empty($price_grp) ? @num_format($price_grp->price_inc_tax) : 0, ['class' => 'form-control input-sm input_number']); !!}
		</div>
	@endforeach
</td>
