...
<tr>
    ...
    <td class="{{$class}}">
        {!! Form::label($name . '_' . $variation_index . '_variations_' . $value_index . '_sell_price_inc_tax', __('product.default_selling_price') .':') !!}
{{--        {!! Form::text($name . '[' . $variation_index . '][variations][' . $value_index . '][default_sell_price]', $default, ['class' => 'form-control input-sm variable_dsp input_number', 'placeholder' => __('product.exc_of_tax'), 'required']); !!}--}}
        {!! Form::text($name . '[' . $variation_index . '][variations][' . $value_index . '][sell_price_inc_tax]', $default, ['class' => 'form-control input-sm variable_dsp_inc_tax input_number', 'required']); !!}

        @foreach($price_groups as $price_group)
            <br>
            {!! Form::label($name . '_' . $variation_index . '_variations_' . $value_index . '_price_groups_'. $price_group->id, $price_group->name .':') !!}
            {!! Form::text($name . '[' . $variation_index . '][variations][' . $value_index . '][price_groups]['. $price_group->id .']', null, ['class' => 'form-control input-sm input_number', 'id' => $name . '_' . $variation_index . '_variations_' . $value_index . '_price_groups_'. $price_group->id]); !!}
        @endforeach
    </td>
