...
{{--				</div>--}}
				<div class="form-group col-xs-12 {{$hide_tax}}">
					...
					{!! Form::select("products[$row_count][tax_id]", $tax_dropdown['tax_rates'], $tax_id, ['placeholder' => __('messages.please_select'), 'class' => 'form-control tax_id'], $tax_dropdown['attributes']); !!}
				</div>
				@php
