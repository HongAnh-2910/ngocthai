<div class="row">
	...
	<div class="{{$col_class}}">
		<div class="form-group">
			{!! Form::label("method_$row_index" , __('lang_v1.amount_payment') . ': ' . number_format($paid)) !!}
{{--			<div class="input-group">--}}
{{--				<span class="input-group-addon">--}}
{{--					<i class="fas fa-money-bill-alt"></i>--}}
{{--				</span>--}}
{{--				{!! Form::select("payment[$row_index][method]", [], $payment_line['method'], ['class' => 'form-control col-md-12 payment_types_dropdown', 'required', 'id' => "method_$row_index", 'style' => 'width:100%;', 'placeholder' => __('messages.please_select')]); !!}--}}
{{--			</div>--}}
		</div>
	</div>
	<div class="{{$col_class}}">
		<div class="form-group">
			{!! Form::label("amount_$row_index" ,__('sale.un_paid') . ': ' . number_format($un_paid)) !!}
{{--			<div class="input-group">--}}
{{--				<span class="input-group-addon">--}}
{{--					<i class="fas fa-money-bill-alt"></i>--}}
{{--				</span>--}}
...
{{--				{!! Form::text("payment[$row_index][amount]", empty($total) ? @num_format($payment_line['amount']) : number_format($total), ['class' => 'form-control payment-amount input_number', 'required', 'id' => "amount_$row_index", 'placeholder' => __('sale.amount')]); !!}--}}
{{--			</div>--}}
		</div>
	</div>
	@if(!empty($accounts))
