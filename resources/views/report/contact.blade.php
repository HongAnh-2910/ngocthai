@extends('layouts.app')
@section('title', __('report.debt_report'))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1>{{ __('report.debt_report')}}</h1>
    <!-- <ol class="breadcrumb">
        ...
        <div class="col-md-12">
            @component('components.filters', ['title' => __('report.filters')])
                ...
                <div class="col-md-3">
                    ...
                    <br>
                    <span class="display_currency total_payment" data-currency_symbol="true" style="font-size: 20px;padding-right: 10px">0</span>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <br>
                    <span class="display_currency total_due_splice" data-currency_symbol="true" style="font-size: 20px;padding-right: 10px">0</span>
                </div>
            @endcomponent
        </div>
    </div>
...
{{--                            <th>@lang('lang_v1.total_purchase_return')</th>--}}
                            ...
                            <th>@lang('lang_v1.total_revenue')</th>
...
{{--                            <td><span class="display_currency" id="footer_total_purchase_return" data-currency_symbol ="true"></span></td>--}}
                            ...
                            <td><span class="display_currency" id="footer_total_revenue" data-currency_symbol ="true"></span></td>
