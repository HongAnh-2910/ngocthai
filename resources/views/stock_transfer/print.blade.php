    ...
    <div class="table-responsive">
      <table class="table bg-gray">
        ...
        @php
          $total = 0.00;
        @endphp
        @foreach( $stock_transfer_details as $details )
          <tr>
            <td>
              {{ $details->product }}
            ...
            <td>
              {{ $details->unit_type == \App\Unit::PCS ? '--' : number_format($details->height, 2) }}
            </td>
            <td>
              {{ $details->unit_type == \App\Unit::PCS ? '--' : number_format($details->width, 2) }}
            </td>
            <td>
...
{{--        </tr>--}}
        ...
        <tr>
          ...
          <td></td>
          <td><span class="display_currency pull-right" data-currency_symbol="true" >{{ $sell_transfer->shipping_charges + $total }}</span></td>
        </tr>
      </table>
    </div>
  </div>
