      ...
      <div id="permissions_box" style="display: none">
          ...
          @foreach($locations as $location)
              <div class="col-md-2">
                  <div class="checkbox">
                      <label>
                          {!! Form::checkbox('location_permissions['. $location->id .'][location]', 'location.' . $location->id, false,
              ...
              <div class="col-md-10">
                  <div class="col-md-12">
                      <div class="checkbox">
                          <label>
                              {!! Form::checkbox('location_permissions['. $location->id .'][access_all_warehouses]', 'access_all_warehouses', false,
                  ...
                  @foreach($location->warehouses as $warehouse)
                      <div class="col-md-12">
                          <div class="checkbox">
                              <label>
                                  {!! Form::checkbox('location_permissions['. $location->id .'][warehouses][]', 'warehouse.' . $warehouse->id, false,
