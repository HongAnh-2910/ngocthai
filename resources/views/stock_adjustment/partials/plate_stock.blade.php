        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">
                    @lang('stock_adjustment.select_plate_to_adjustment')
                </h4>
            </div>
                        ...
                        @component('components.filters', ['title' => __('report.filters')])
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    {!! Form::label('adjust_warehouse_id', __('lang_v1.adjust_warehouse') . ':') !!}
                                    {!! Form::select('adjust_warehouse_id', $warehouse, null, ['placeholder' => __('messages.all'), 'class' => 'form-control', 'style' => 'width:100%']); !!}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
