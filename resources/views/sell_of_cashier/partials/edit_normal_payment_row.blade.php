<div class="modal-dialog modal-lg" role="document">
  <div class="modal-content">
    {!! Form::open(['url' => action('TransactionPaymentController@updateNormal', [$payment_line->id]), 'method' => 'put', 'id' => 'transaction_payment_add_form', 'files' => true ]) !!}
    <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      <h4 class="modal-title">@lang( 'sale.approve_normal' )</h4>
    </div>
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              {!! Form::hidden("type", $payment_line->type) !!}
              {!! Form::text("amount", $payment_line->type == 'expense' ? @num_format(-1*$payment_line->amount) : @num_format($payment_line->amount), ['class' => 'form-control input_number', 'required', 'placeholder' => 'Amount', 'readonly']); !!}
            </div>
          </div>
        </div>
        <div class="col-md-4">
