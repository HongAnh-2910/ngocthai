<div class="modal-dialog modal-lg" role="document">
  <div class="modal-content">
    {!! Form::open(['url' => action('TransactionPaymentController@updateDeposit', [$payment_line->id]), 'method' => 'put', 'id' => 'transaction_payment_add_form', 'files' => true ]) !!}
    <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      <h4 class="modal-title">@lang( 'sale.approve_deposit' )</h4>
    </div>
    ...
    <div class="modal-body">
      ...
      <div class="row payment_row">
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              {!! Form::text('paid_on', @format_datetime($paid_on), ['class' => 'form-control', 'readonly', 'required']); !!}
            </div>
          </div>
        </div>
        <div class="col-md-4">
        ...
        @if(!empty($accounts))
          <div class="col-md-6">
            <div class="form-group">
              {!! Form::label("account_id_deposit" , __('lang_v1.payment_account') . ':') !!}
              <div class="input-group">
                <span class="input-group-addon">
                  <i class="fas fa-money-bill-alt"></i>
                </span>
                {!! Form::select("account_id", $accounts, !empty($payment_line->account_id) ? $payment_line->account_id : '' , ['class' => 'form-control select2 account_id', 'id' => "account_id_deposit", 'style' => 'width:100%;']); !!}
              </div>
            </div>
          </div>
        @endif
    ...
    <div class="modal-footer">
      <button type="button" class="btn btn-primary" id="payment-button" data-confirmed="1">@lang( 'messages.confirm' )</button>
      <button type="button" class="btn btn-danger" id="reject-button" data-confirmed="0" {{ $show_reject_button ? '' : 'style=display:none' }}>@lang( 'messages.reject' )</button>
