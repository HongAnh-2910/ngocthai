<div class="modal-dialog modal-lg" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('TransactionPaymentController@storeRemaining'), 'method' => 'post', 'id' => 'transaction_payment_add_form', 'files' => true ]) !!}
    {!! Form::hidden('transaction_id', $transaction->id); !!}

    <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      <h4 class="modal-title">@lang( 'sale.approve_remaining' )</h4>
    </div>
    ...
    <div class="modal-body">
      ...
      <div class="row payment_row">
        <div class="col-md-4">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              {!! Form::text("amount", @num_format($payment_line->amount), ['class' => 'form-control input_number', 'required', 'placeholder' => 'Amount', 'data-rule-max-value' => @num_format($payment_line->amount), 'data-msg-max-value' => __('lang_v1.max_amount_to_be_paid_is', ['amount' => $amount_formated]), 'readonly']); !!}
            </div>
          </div>
        </div>
        <div class="col-md-4">
        ...
        @if(!empty($accounts))
          <div class="col-md-6">
            <div class="form-group">
              {!! Form::label("account_id_remaining" , __('lang_v1.payment_account') . ':') !!}
              <div class="input-group">
                <span class="input-group-addon">
                  <i class="fas fa-money-bill-alt"></i>
                </span>
                {!! Form::select("account_id", $accounts, !empty($payment_line->account_id) ? $payment_line->account_id : '' , ['class' => 'form-control select2 account_id', 'id' => "account_id_remaining", 'style' => 'width:100%;']); !!}
              </div>
            </div>
          </div>
        @endif
    ...
    <div class="modal-footer">
      <button type="button" class="btn btn-primary" id="payment-button">@lang( 'messages.confirm' )</button>
