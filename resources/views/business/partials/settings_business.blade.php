...
{{--        </div>--}}
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('payment_create_days', __('business.payment_create_days') . ':*') !!}
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-edit"></i>
                    </span>
                    {!! Form::number('payment_create_days', $business->payment_create_days, ['class' => 'form-control','placeholder' => __('business.payment_create_days'), 'required']); !!}
                </div>
            </div>
        </div><div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('payment_approval_days', __('business.payment_approval_days') . ':*') !!}
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-edit"></i>
                    </span>
                    {!! Form::number('payment_approval_days', $business->payment_approval_days, ['class' => 'form-control','placeholder' => __('business.payment_approval_days'), 'required']); !!}
                </div>
            </div>
        </div>
        <div class="clearfix"></div>
