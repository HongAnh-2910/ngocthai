<div class="pos-tab-content">
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('area_allow_cut', __('sale.area_allow_cut') . ':') !!}
                {!! Form::text('pos_settings[area_allow_cut]', !empty($pos_settings['area_allow_cut']) ? $pos_settings['area_allow_cut'] : 0, ['class' => 'form-control']) !!}
            </div>
        </div>
...
{{--                    !empty($pos_settings['allow_overselling']) ? true : false ,--}}
                  <label>
                    {!! Form::checkbox('pos_settings[allow_overselling]', 1, true,
