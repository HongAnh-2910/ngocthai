    ...
    <nav class="navbar navbar-static-top" role="navigation">
      ...
      <div class="navbar-custom-menu">
        ...
        @php
          ...
          $is_closed = $moduleUtil->isClosedEndOfDay();
        @endphp
          {!! Form::open(['url' => action('BusinessController@closeEndOfDay'), 'method' => 'post', 'id' => 'close_end_of_day_form']) !!}
          <button id="close_end_of_day_button" title="@lang('lang_v1.close_end_of_day')" type="button" data-toggle="tooltip" data-placement="bottom"
                  class="btn btn-success btn-flat pull-left m-8 hidden-xs btn-sm mt-10" {{ $is_closed ? 'disabled' : '' }}>
            <strong><i class="fas {{ $is_closed ? 'fa-unlock' : 'fa-lock' }}"></i> </strong>
          </button>
        {!! Form::close() !!}
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a class="btn btn-default btn-flat" href="{{ action('Auth\LoginController@logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
