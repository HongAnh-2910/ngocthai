<div class="table-responsive">
    @if($permissions && in_array('create', $permissions))
        <div class="pull-right">
            <button style="margin: 10px 0px" type="button" class="btn btn-sm btn-primary docs_and_notes_btn pull-right" data-href="{{action('DocumentAndNoteController@create', ['notable_id' => $notable_id, 'notable_type' => $notable_type])}}">
                @lang('messages.add')&nbsp;
