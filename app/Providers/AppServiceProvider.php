...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        //Blade directive to format size (width, height, area) into required format.
        Blade::directive('size_format', function ($expression) {
            return "number_format($expression, config('constants.size_precision', 3), session('currency')['decimal_separator'], session('currency')['thousand_separator'])";
        });

        //Blade directive to format weight into required format.
        Blade::directive('weight_format', function ($expression) {
            return "number_format($expression, config('constants.weight_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator'])";
        });
