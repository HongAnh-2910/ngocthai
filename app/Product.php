...
class Product extends Model
{
    ...
    */
    ...
    {
        return $this->belongsTo(\App\Unit::class, 'default_sub_unit_id', 'id');
    }
    ...
    public function setSubUnitIdsAttribute($sub_unit_ids)
    {
        $this->attributes['sub_unit_ids'] = json_encode($sub_unit_ids);
    }
}
