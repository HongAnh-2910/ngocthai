    ...
    public static function defaultNotificationTemplates($business_id = null)
    {
        $notification_template_data = [
            [
                ...
                'email_body' => '<p>Kính gửi {contact_name},</p>

                    <p>Số hóa đơn của bạn là {invoice_number}<br />
                    Tổng số lượng: {total_amount}<br />
                    Số tiền đã trả: {received_amount}</p>

                    <p>Cảm ơn đã tin tưởng và mua sắm sản phẩm của chúng tôi.</p>

                    <p>{business_logo}</p>

                    <p>&nbsp;</p>',
                'sms_body' => 'Kính gửi {contact_name}, cảm ơn quý khách đã tin tưởng và mua sắm tại . {business_name}',
                'subject' => 'Gửi lời cảm ơn tới {business_name}',
                'auto_send' => '0'
            ],
            ...
            [
                ...
                'subject' => 'Đơn hàng mới, từ {business_name}',
                'auto_send' => '0'
            ],
            [
                'business_id' => $business_id,
                ...
                'subject' => 'Đã thanh toán, từ {business_name}',
                'auto_send' => '0'
            ],
            [
                'business_id' => $business_id,
                ...
                'subject' => 'Đã nhận hàng, từ {business_name}',
                'auto_send' => '0'
            ],
            [
                'business_id' => $business_id,
                ...
                'subject' => 'Đang xử lý đơn hàng, từ {business_name}',
                'auto_send' => '0'
            ]
        ];
