...
class Transaction extends Model
{
    ...
    const APPROVE_BY_CASHIER     = 1;
    const NOT_APPROVE_BY_CASHIER = 0;
    ...
    public function transaction_expense()
    {
        return $this->hasOne(\App\TransactionExpense::class, 'transaction_id');
    }

    public function transaction_receipt()
    {
        return $this->hasOne(\App\TransactionReceipt::class, 'transaction_id');
    }
    ...
    {
        return $this->hasMany(\App\TransactionExpense::class);
    }
    ...
    public static function transactionTypes()
    {
        return  [
                ...
                'receipt' => __('sale.receipt'),
                'expense' => __('sale.expense'),
            ];
    }
    ...
    {
        return $this->hasMany(\App\TransactionPlateLine::class);
    }
}
