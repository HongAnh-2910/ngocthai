...
class BusinessUtil extends Util
{
    ...
    public function newBusinessDefaultResources($business_id, $user_id)
    {
        ...
        InvoiceScheme::create(['name' => 'Mặc định',
                            'scheme_type' => 'blank',
                            'prefix' => '',
                            'start_number' => 1,
                            'total_digits' => 4,
        ...
        InvoiceLayout::create(['name' => 'Mặc định',
                        'header_text' => null,
                        'invoice_no_prefix' => 'Số hóa đơn.',
                        'invoice_heading' => 'Hóa đơn',
                        'sub_total_label' => 'Tổng phụ',
                        ...
                        'total_due_label' => 'Tổng nợ',
                        'paid_label' => 'Tổng thanh toán',
                        'show_payments' => 1,
                        'show_customer' => 1,
                        'customer_label' => 'Khách hàng',
                        'table_product_label' => 'Sản phẩm',
                        'table_qty_label' => 'Số lượng',
                        'table_unit_price_label' => 'Đơn giá',
                        'table_subtotal_label' => 'Tổng phụ',
                        'date_label' => 'Ngày'
                    ]);
...
//            ],
    ...
    public function createNewBusiness($business_details)
    {
        ...
        $business_details['enable_sub_category'] = 0;
        $business_details['enable_purchase_status'] = 0;
        $business_details['item_addition_method'] = 0;
       return $business = Business::create_business($business_details);
    ...
    {
        return ['disable_pay_checkout' => 0, 'disable_draft' => 0, 'disable_express_checkout' => 0, 'hide_product_suggestion' => 0, 'hide_recent_trans' => 0, 'disable_discount' => 0, 'disable_order_tax' => 0, 'is_pos_subtotal_editable' => 0, 'allow_overselling' => 1, 'area_allow_cut' => 0];
    }
